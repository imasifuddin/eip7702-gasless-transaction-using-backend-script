...
function executeFoundryScript(scriptName, privateKey, additionalEnv = {}) {
    // console.log('🔍 RPC URL:', process.env.SEPOLIA_RPC_URL || 'NOT FOUND');
    return new Promise((resolve, reject) => {
        // Get RPC URL from env or use public fallback
        ...
        const command = `forge script script/${scriptName} --rpc-url ${rpcUrl} --private-key ${privateKey} --broadcast --skip-simulation -vvv`;
